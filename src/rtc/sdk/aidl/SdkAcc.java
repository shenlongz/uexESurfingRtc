 ...
 * Original file: F:\\workspace\\eclipse_workspace\\workspace\\uexESurfingRtc\\src\\rtc\\sdk\\aidl\\SdkAcc.aidl
 */
...
case TRANSACTION_optGroupVoice:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
this.optGroupVoice(_arg0, _arg1);
reply.writeNoException();
return true;
}
}
...
@Override public void optGroupVoice(int action, java.lang.String parameters) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_optGroupVoice, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_optGroupVoice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
// 设置通知对象
...
public void optGroupVoice(int action, java.lang.String parameters) throws android.os.RemoteException;
}
